            ...
            <div className="max-w-[1200px] mx-auto py-10 px-5">
                <div className="card">
                    <div className="flex justify-between items-center pb-5 border-b-2 border-gray-100 mb-10">
                        <h2 className="text-2xl font-bold text-harvest-green">👨‍🌾 Behind the Scenes</h2>
                    ...
                    <div className="max-w-2xl mx-auto text-center py-16">
                        ...
                        <p className="text-gray-600 text-lg leading-relaxed mb-10">
                            The Behind the Scenes template lets you pull back the curtain on your farm operations — showcasing early morning routines, planting days, equipment in action, and the real work that goes into every harvest, helping followers connect with the people behind their food.
                        </p>
                        <div className="bg-harvest-light border-l-4 border-harvest-green p-6 rounded-r-lg text-left mb-10">
                            ...
                            <ul className="text-sm text-gray-700 space-y-1">
                                <li>• Photo-first workflow for farm life moments</li>
                                <li>• Authentic, conversational caption styles</li>
                                <li>• Story arc suggestions to humanize your brand</li>
                            </ul>
                        </div>
