...
const CONTENT_TYPE = "behind-scenes";
const CONFIG = TEMPLATE_CONFIG[CONTENT_TYPE];

export default function BehindScenesWorkflow() {
    ...
    // Keep photoTransfer in sync with photos/videos state so the content page
    // always gets the latest selection regardless of how/when handleNext fires.
    useEffect(() => {
                ...
                <div className="card">
                    ...
                    <div className="max-w-3xl mx-auto">
                        <div className="text-center mb-10">
                            <h3 className="text-3xl font-bold mb-3">What are you sharing today?</h3>
