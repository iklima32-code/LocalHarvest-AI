...
export default function RecipeWorkflow() {
                ...
                <div className="card">
                    ...
                    <div className="max-w-3xl mx-auto">
                        <div className="text-center mb-10">
                            <h3 className="text-3xl font-bold mb-3">What recipe are you sharing?</h3>
                                    ...
                                    {CONFIG.extra1Label && (
                                        <div>
                                            ...
                                            <input
                                                ...
                                                onChange={(e) =>
                                                    setFormData({ ...formData, extra1: e.target.value } as ContentFormData)
                                                }
                                                className="w-full p-4 border-2 border-gray-200 rounded-xl focus:border-harvest-green outline-none transition-all bg-white"
                                                placeholder={CONFIG.extra1Placeholder}
                                            />
                                        </div>
                                    )}
