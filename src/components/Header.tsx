...
export default function Header() {
    ...
    // Don't show header if not logged in (home/login/signup have their own or none)
    ...
    return (
        <header className="bg-white border-b border-gray-100 py-3 sticky top-0 z-[1000] backdrop-blur-md bg-white/80">
            <div className="max-w-[1200px] mx-auto px-5 flex justify-between items-center">
                <Link href="/dashboard" className="flex items-center gap-2 text-xl font-extrabold cursor-pointer text-[#006633]">
                ...
                <button className="md:hidden text-[#006633] text-2xl">☰</button>
            </div>
        </header>
    );
}
